            ...
            <div className="container">
                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="m-auto text-center md:w-8/12">
                        <h2 className="text-2xl text-black-trot font-bold md:text-4xl">{t("Need")} <span
                            className="text-orange-300">{t("help")} </span></h2>
                ...
                <div className="mt-12 grid gap-6 md:grid-cols-2 lg:flex lg:space-x-8">
                    <div className="relative md:col-span-1 group lg:w-[32%]">
                        <div aria-hidden="true"
                             className="absolute top-0 w-full h-full rounded-2xl p-4 bg-white transition duration-500 group-hover:scale-105 lg:group-hover:scale-110"></div>
                        <div className="relative p-6 space-y-6">
                            <div className="relative">
                                <div
                                    class=" w-[70px] h-[70px] flex items-center justify-center bg-orange-300 rounded-2xl mb-2">
                ...
                <div className="grid grid-cols-2 mt-24">
                    ...
                    <div className="order-1 col-span-full">
                        <MapContainer className="max-w-7xl max-h-60" center={[45.764043, 4.835659]} zoom={14}
                        ...
                        <form action="" className="mx-auto max-w-xl space-y-4">
                            <div className="">
                                <input onChange={(e) => setLastname(e.target.value)}
                                       disabled={status?.type === "success" && true}
                                       type="text" id="nom"
                    ...
                    <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
                        ...
                        <div className="mx-auto max-w-xl flex flex-col space-y-5">
                            ...
                            <p className="text-sm text-gray-500 leading-6">18 Avenue des Champs-Élysées, <br /> 75008
                                Paris <br /> France</p>
                ...
                {status?.type === "success" && <div
                    ...
                    role="alert">
                    <span
                        className="font-medium">{t("Ticket sent!")}</span> {t("A response from support will be sent to you by email as soon as possible :)")}
                </div>}
                ...
                {status?.type === "error" && (
                    <div
                        ...
                        role="alert">
                        <span
                            className="font-medium">{t("Error sending ticket!")}</span> {t("The maintenance team takes care of it!")}
                    </div>
                )}
