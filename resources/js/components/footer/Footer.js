    ...
    return (
        ...
        <footer className="static bottom-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#353535" fillOpacity="1"
                      d="M0,192L60,170.7C120,149,240,107,360,122.7C480,139,600,213,720,229.3C840,245,960,203,1080,202.7C1200,203,1320,245,1380,266.7L1440,288L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
            </svg>
            <div className="md:px-12 lg:px-28 bg-black-trot">
                <div className="container m-auto space-y-6 text-black-trot">
                    <div className="uppercase font-black no-underline pt-2 pl-5">

                        <div className="w-56 m-auto">
                            <NavLink
                                className="uppercase text-white-background hover:text-white font-black text-3xl no-underline"
                                to="/Main">
                                Easy
                            </NavLink>
                    ...
                    <ul role="list"
                        ...
                        <li role="listitem"><a href="#"
                                               className="text-white hover:text-orange-300 no-underline">Home</a></li>
                        <li role="listitem"><a href="#"
                                               className="text-white hover:text-orange-300 no-underline">Features</a>
                        </li>
                        <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">Get
                            started</a></li>
                        <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">About
                            us</a></li>
                    </ul>
                    <div className="text-white w-max m-auto flex items-center justify-between space-x-4">
                        <a href="tel:+243996660436" aria-label="call">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="w-5 m-auto text-white" viewBox="0 0 16 16">
                ...
                <a href="#" title="facebook" target="blank" aria-label="facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-5 m-auto text-white"
                         viewBox="0 0 16 16">
                        <path
