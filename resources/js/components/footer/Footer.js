    ...
    <div className="md:px-12 lg:px-28 bg-black-trot">
        <div className="container m-auto space-y-6 text-black-trot">
            ...
            <ul role="list" className="py-4 flex flex-col gap-4 items-center justify-center sm:flex-row sm:gap-8">
                <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">Home</a></li>
                <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">Features</a>
                </li>
                <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">Get
                    started</a></li>
                <li role="listitem"><a href="#" className="text-white hover:text-orange-300 no-underline">About us</a>
                </li>
            </ul>
